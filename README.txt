...
-- Initially 8 logins are used to build up the mean and average. For logins after that, recalculation of hardened password is done using appropriate values (alpha or beta based on conditions).
-- Testfile format:
